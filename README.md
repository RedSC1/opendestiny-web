...
一个本地优先的在线排盘与历法工具站，包含八字排盘、紫微斗数、塔罗牌、万年历和气朔推算，并支持简体中文与繁體中文切换。八字与紫微斗数支持天文年 −6000～10000，亦即公元前 6001 年至公元 10000 年（天文年 0 表示公元前 1 年）。
...
| 工具 | 功能 |
| --- | --- |
| 八字排盘 | 支持天文年 −6000～10000；包含四柱、十神、神煞、大运与流年，以及出生城市、时区和真太阳时修正 |
| 紫微斗数 | 支持天文年 −6000～10000；包含十二宫、主星、四化与流运，并与八字共用出生资料和命例簿 |
